        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="mt-8">
            ...
            <p className="text-gray-600 mb-6">
              These books are perfect for those starting their journey in learning Arabic.
              They provide a solid foundation in basic grammar, vocabulary, and conversation.
            </p>
            {isLoading ? (
          ...
          <div className="mt-12">
            ...
            <p className="text-gray-600 mb-6">
              These are classical Arabic grammar books that have been used for centuries.
              They provide a deeper understanding of Arabic grammar and syntax.
            </p>
            {isLoading ? (
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {[1, 2, 3].map((i) => (
