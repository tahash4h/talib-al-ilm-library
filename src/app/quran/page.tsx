...
export default function QuranPage() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      const quranBooks = books.filter(book => book.category === 'quran')
      setFilteredBooks(quranBooks)
      setIsLoading(false)
    }, 500)
  ...
  useEffect(() => {
    const quranBooks = books.filter(book => book.category === 'quran')
    const filtered = quranBooks.filter(book =>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900">Quran</h1>
            <p className="mt-2 text-gray-600">
              Explore translations and tafsir of the Holy Quran
            </p>
          </div>
          ...
          <SearchBar
            ...
            placeholder="Search Quran books..."
          />
          ...
          <div className="mt-8">
            ...
            <p className="text-gray-600 mb-6">
              These translations are perfect for beginners who want to understand the meaning of the Quran. 
              We recommend reading them alongside a tafsir playlist to gain deeper understanding.
            </p>
            {isLoading ? (
          ...
          <div className="mt-12">
            ...
            <p className="text-gray-600 mb-6">
              These tafsir books provide detailed explanations and interpretations of the Quran. 
              They are best studied with a qualified teacher or through structured courses.
            </p>
            {isLoading ? (
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {[1, 2, 3].map((i) => (
