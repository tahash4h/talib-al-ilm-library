...
export default function SeerahPage() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      const seerahBooks = books.filter(book => book.category === 'seerah')
      setFilteredBooks(seerahBooks)
      setIsLoading(false)
    }, 500)
  ...
  useEffect(() => {
    const seerahBooks = books.filter(book => book.category === 'seerah')
    const filtered = seerahBooks.filter(book =>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900">Seerah</h1>
            <p className="mt-2 text-gray-600">
              Explore the life and biography of Prophet Muhammad (peace be upon him)
            </p>
          </div>
          ...
          <SearchBar
            ...
            placeholder="Search Seerah books..."
          />
          ...
          <div className="mt-8">
            ...
            <p className="text-gray-600 mb-6">
              These books provide an accessible introduction to the life of Prophet Muhammad (peace be upon him).
              They are written in a clear and engaging style, perfect for those new to studying Seerah.
            </p>
            {isLoading ? (
          ...
          <div className="mt-12">
            ...
            <p className="text-gray-600 mb-6">
              These are more detailed and scholarly works on the life of Prophet Muhammad (peace be upon him).
              They provide deeper insights and historical context for those ready to advance their study.
            </p>
            {isLoading ? (
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {[1, 2, 3].map((i) => (
