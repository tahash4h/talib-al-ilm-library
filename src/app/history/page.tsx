        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="mb-8">
            ...
            <p className="mt-2 text-gray-600">
              Explore the rich history of Islam and Islamic civilization
            </p>
          </div>
          ...
          <SearchBar
            ...
            placeholder="Search history books..."
          />
          ...
          <div className="mt-8">
            ...
            <p className="text-gray-600 mb-6">
              These books provide an accessible introduction to Islamic history,
              covering the life of Prophet Muhammad and the early Islamic period.
            </p>
            {isLoading ? (
          ...
          <div className="mt-12">
            ...
            <p className="text-gray-600 mb-6">
              These are classical works of Islamic historiography that provide
              detailed accounts of Islamic history and civilization.
            </p>
            {isLoading ? (
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {[1, 2, 3].map((i) => (
