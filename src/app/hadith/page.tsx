...
export default function HadithPage() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      const hadithBooks = books.filter(book => book.category === 'hadith')
      setFilteredBooks(hadithBooks)
      setIsLoading(false)
    }, 500)
  ...
  useEffect(() => {
    const hadithBooks = books.filter(book => book.category === 'hadith')
    const filtered = hadithBooks.filter(book =>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900">Hadith</h1>
            <p className="mt-2 text-gray-600">
              Explore authentic collections of Hadith
            </p>
          </div>
          ...
          <div className="mt-8">
            ...
            <p className="text-gray-600 mb-6">
              These collections are perfect for beginners who want to learn about the sayings and actions of Prophet Muhammad (peace be upon him).
              We recommend studying them with a qualified teacher or through structured courses.
            </p>
            {isLoading ? (
          ...
          <div className="mt-12">
            ...
            <p className="text-gray-600 mb-6">
              These are the major hadith collections that form the foundation of Islamic knowledge.
              They require a deeper understanding of Arabic and Islamic sciences to study properly.
            </p>
            {isLoading ? (
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {[1, 2, 3].map((i) => (
