...
export const books: Book[] = [
  ...
  {
    id: 25,
    title: 'Principles of Hanafi Jurisprudence',
    author: 'Imam Sarakhsi',
    description: 'An introduction to the foundational principles of Hanafi fiqh.',
    downloadUrl: '#',
    readUrl: '#',
    category: 'fiqh',
    school: 'Hanafi',
  ...
  {
    id: 26,
    title: 'Hanafi Rulings Simplified',
    author: 'Mufti Taqi Usmani',
    description: 'A modern guide to Hanafi rulings for everyday life.',
    downloadUrl: '#',
    readUrl: '#',
    category: 'fiqh',
    school: 'Hanafi',
  ...
  {
    id: 27,
    title: 'Foundations of Maliki Fiqh',
    author: 'Imam al-Qarafi',
    description: 'A foundational text on Maliki jurisprudence.',
    downloadUrl: '#',
    readUrl: '#',
    category: 'fiqh',
    school: 'Maliki',
  ...
  {
    id: 28,
    title: 'Maliki Practices Explained',
    author: 'Sheikh Abdullah bin Bayyah',
    description: 'A practical guide to Maliki fiqh for contemporary Muslims.',
    downloadUrl: '#',
    readUrl: '#',
    category: 'fiqh',
    school: 'Maliki',
  ...
  {
    id: 29,
    title: 'Shafi\'i Legal Methodology',
    author: 'Imam Nawawi',
    description: 'A classic work on Shafi\'i legal theory and practice.',
    downloadUrl: '#',
    readUrl: '#',
    category: 'fiqh',
    school: 'Shafi\'i',
  ...
  {
    id: 30,
    title: 'Shafi\'i Fiqh for Beginners',
    author: 'Sheikh Alawi al-Maliki',
    description: 'An accessible introduction to Shafi\'i jurisprudence.',
    downloadUrl: '#',
    readUrl: '#',
    category: 'fiqh',
    school: 'Shafi\'i',
  ...
  {
    id: 31,
    title: 'Hanbali Foundations',
    author: 'Ibn Qudamah',
    description: 'A foundational text on Hanbali jurisprudence.',
    downloadUrl: '#',
    readUrl: '#',
    category: 'fiqh',
    school: 'Hanbali',
  ...
  {
    id: 32,
    title: 'Hanbali Fiqh Essentials',
    author: 'Sheikh Saleh al-Fawzan',
    description: 'A concise guide to Hanbali rulings and methodology.',
    downloadUrl: '#',
    readUrl: '#',
    category: 'fiqh',
    school: 'Hanbali',
